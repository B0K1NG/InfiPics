...
const FLICKR_API_URL = import.meta.env.VITE_FLICKR_API_URL;
...
function useFetchPhotos(initialPage = 1) {
    ...
    setLoading(true);
    try {
        const response = await fetch(`${FLICKR_API_URL}&page=${page}&per_page=${PHOTOS_PER_PAGE}&extras=owner_name`);
